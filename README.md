...
[![Download for Windows](https://img.shields.io/github/v/release/Hixly/huncho?style=flat-square&label=download&color=f5b301)](https://github.com/Hixly/huncho/releases/latest)
...
- **Remembers you.** It learns your preferences and routines across sessions, locally.
- **Gets faster the more you use it.** Repeated commands ("open YouTube") replay instantly without calling the AI again.
- **Asks before spending money.** It acts freely on everything except purchases and payments, which always require your confirmation.
...
2. **Your speech is transcribed locally** on your machine by Moonshine, an on-device model. No cloud, no audio upload.
...
1. Download the latest installer from the [Releases page](https://github.com/Hixly/huncho/releases/latest) and run it.
...
- **The only outbound data** is the text of your commands, sent to Google Gemini using **your** key under **your** Google account and terms.
...
Huncho is a real, working daily driver, but still evolving. Hands-free wake-word ("just say its name") is built but disabled by default, because general speech-to-text can't reliably hear a made-up word. **`Ctrl+H` push-to-talk is the primary trigger** and works perfectly.
